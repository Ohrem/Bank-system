...
public class CreditServiceBillDaoImpl implements DepositBillDao {
    private final ConnectionPool connectionPool = ConnectionPool.getInstance();
    private static final String SQL_INSERT_SERVICE_BILL = "INSERT INTO credit_service_bill (number, credit_agreement_id, credit_agreement_number) VALUES (?,?,?);";
    private static final String SQL_UPDATE_MAIN_BILL = "UPDATE credit_service_bill SET bill_amount = ? WHERE credit_agreement_number = ?;";
    private static final String SQL_DELETE_MAIN_BILL = "DELETE FROM credit_service_bill WHERE credit_agreement_number = ?;";
    private static final String SQL_FIND_ALL_MAIN_BILLS = "SELECT number, bill_amount, credit_agreement_id, credit_agreement_number from credit_service_bill;";
    private static final String SQL_FIND_MAIN_BILL_BY_AGREEMENT_NUMBER = "SELECT number, bill_amount, credit_agreement_id, credit_agreement_number from credit_service_bill WHERE credit_agreement_number = ?;";
    private static CreditServiceBillDaoImpl INSTANCE;

    public CreditServiceBillDaoImpl(){
    }

    public static CreditServiceBillDaoImpl getInstance(){
        if (INSTANCE == null){
            INSTANCE = new CreditServiceBillDaoImpl();
        }
        return INSTANCE;
    }
