...
public class CreditMainBillDaoImpl implements DepositBillDao {
    private final ConnectionPool connectionPool = ConnectionPool.getInstance();
    private static final String SQL_INSERT_MAIN_BILL = "INSERT INTO credit_main_bill (number, bill_amount, credit_agreement_id, credit_agreement_number) VALUES (?,?,?,?);";
    private static final String SQL_UPDATE_MAIN_BILL = "UPDATE credit_main_bill SET bill_amount = ? WHERE credit_agreement_number = ?;";
    private static final String SQL_DELETE_MAIN_BILL = "DELETE FROM credit_main_bill WHERE credit_agreement_number = ?;";
    private static final String SQL_FIND_ALL_MAIN_BILLS = "SELECT number, bill_amount, credit_agreement_id, credit_agreement_number from credit_main_bill;";
    private static final String SQL_FIND_MAIN_BILL_BY_AGREEMENT_NUMBER = "SELECT number, bill_amount, credit_agreement_id, credit_agreement_number from credit_main_bill WHERE credit_agreement_number = ?;";
    private static CreditMainBillDaoImpl INSTANCE;


    public static CreditMainBillDaoImpl getInstance(){
        if (INSTANCE == null){
            INSTANCE = new CreditMainBillDaoImpl();
        }
        return INSTANCE;
    }
