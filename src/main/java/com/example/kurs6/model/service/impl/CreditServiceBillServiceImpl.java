...
import com.example.kurs6.model.dao.impl.CreditServiceBillDaoImpl;
...
public class CreditServiceBillServiceImpl implements DepositBillService {
    private final static CreditServiceBillDaoImpl billDao = CreditServiceBillDaoImpl.getInstance();
