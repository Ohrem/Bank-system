...
public class CreateDepositCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        depositData.put(DEPOSIT_TYPE, deposit_type);
        ...
        try {
            ...
            bankBillData.put(ParameterAndAttribute.BALANCE, String.valueOf(userDepositAmount.add(currentBankBalance)));
            bankBillData.put(ParameterAndAttribute.BILL_NUMBER, String.valueOf(BANK_BILL_NUMBER));

            if (depositAgreementService.create(depositData)) {
