...
<div class="container">
    <div class="col-md-12">
        <div class="row" style="margin: 50px 0">
            <h1 style="padding: 0">Все депозиты клиента #${user_id}</h1>
            ...
            <table id="user_deposits" class="table table-light table-striped table-responsive">
                ...
                <c:forEach var="deposit" items="${list}">
                    <tr>
                        ...
                        <td>
                            <c:choose>
                                <c:when test="${deposit.depositType == 'PERPETUAL'}">Бессрочный</c:when>
                                <c:when test="${deposit.depositType == 'SHORT_TERM'}">Краткосрочный</c:when>
                                <c:when test="${deposit.depositType == 'LONG_TERM'}">Долгосрочный</c:when>
                            </c:choose>
                        </td>
