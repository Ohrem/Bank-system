    ...
    <div class="col-md-6 mx-auto">
        ...
        <div class="row">
            <form class="row g-3 " action="controller" method="post" id="deposit_form" onsubmit="return confirm('Уверены?')">
                ...
                <div class="col-6">
                    <label for="start_date" class="form-label">Начало кредита</label>
                ...
                <div class="col-6">
                    <label for="finish_date" class="form-label">Конец кредита</label>
                ...
                <div class="col-6">
                    <label for="deposit_amount" class="form-label">Сумма кредита</label>
                ...
                <div class="col-6">
                    ...
                    <select id="deposit_type" name="credit_type" class="form-select"
                ...
                <div class="col-12" style="width: 100%">
                    <c:if test="${deposit != null}">
                        <input type="hidden" name="command" value="edit_credit">
                        <input type="submit" class="btn btn-success" value="Изменить кредит" style="width: 100%">
                    </c:if>
                    <c:if test="${deposit == null}">
                        <input type="hidden" name="command" value="add_credit">
                        <input type="submit" class="btn btn-success" value="Оформить кредит" style="width: 100%">
                    </c:if>
                </div>
            </form>
        </div>
